...
Next action:
- See `todo_harness_vizier_ssh_first_integration.md` and `todo_ui_vertical_slice_up_status.md` for active work. This item remains only as a redirect and should be removed once the pivot fully lands.
